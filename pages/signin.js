...
function Signup() {
  ...
  const handleSignin = async (e) => {
    ...
    try {
      ...
      .then(() =>  window.location.replace("/search"));
    } catch (err) {
      setSigninError(err.message.substring(9,err.message.length-1));
    }
  };

  return (
    <div class=" h-[100vh] p-8 flex bg-gradient-to-r from-[#FAB2FF] to-[#1904E5] ">
